...
$("#make-new-board").on(customEvent, function () {
  ...
  //Buzzword Bingo Board will be autopopulated with below buzzwords
  var words = ['Function', 'Implement', 'IF', 'Assignment', 'Project', 'Lecture', 'Tutorial', 'Seminar', 'JavaScript', 'Python', 'C++', 'Dissertation', 'Secure', 'AI', 'Code', 'Graduate']

    ref.child("ChloeJones").set({
      words: words
   });

   ref.child("ChloeJones").child('words').on('value', function(snapshot) {
